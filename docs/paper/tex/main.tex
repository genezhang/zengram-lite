...
\author{Gene Zhang\\[0.2em]
\normalsize\href{mailto:genegzhang@gmail.com}{genegzhang@gmail.com}\\[0.2em]
\normalsize\url{https://github.com/genezhang/zengram-lite}}
\date{2026}
...
\textbf{CCS Concepts:} $\bullet$\,\textit{Information systems} $\rightarrow$
\textit{Database management system engines}; \textit{Information retrieval query
processing}; $\bullet$\,\textit{Computing methodologies} $\rightarrow$
\textit{Intelligent agents}; \textit{Knowledge representation and reasoning}.

\smallskip
\textbf{Keywords:} agentic memory, in-browser databases, WebAssembly, vector
search, retrieval-augmented generation, LLM agents, context-window management,
session tracking, provenance.
}
\end{center}
...
web-target bundle attached (publication to npm as \code{zengram-lite} is pending);
it is free for any use, including commercial. The Zengram framework source is
planned for open-source release under Apache-2.0 (publication pending); the Zeta
engine source stays closed, so the WebAssembly build --- which links both --- is
\emph{distributed} as a prebuilt binary rather than itself open source. The
hand-authored surface --- three
...
full Zengram framework, and it is a \textbf{superset} of the zeta-lite database
...
\begin{enumerate}[leftmargin=1.4em,itemsep=0.2em]
  ...
  \item \textbf{Position in the Zeta/Zengram family}: the smallest, most complete
    public form of the full framework, and the in-browser teaser for it.
\end{enumerate}
...
the full Zengram framework this teaser fronts. The authoritative,
...
the full Zengram framework this build fronts (planned for open-source release under
Apache-2.0) and the closed Zeta engine beneath it.
...
one. Zengram-lite is the smallest and most complete public form of the full
...
{\small
\emph{The items marked as zengram-lite's own artifacts are reproducible from the
public repository.}

\begin{description}[leftmargin=3.2em,style=nextline,itemsep=0.3em]
  \item[{[ZL]}] G. Zhang. \emph{Zeta-Lite: A Concurrent, Branchable In-Browser SQL
    Database for Agentic Memory.} arXiv:2609.01818, 2026.
    \url{https://arxiv.org/abs/2609.01818}. Repository:
    \url{https://github.com/genezhang/zeta-lite}. The account
  ...
  \item[{[1]}] C. Packer, S. Wooders, K. Lin, V. Fang, S. G. Patil, I. Stoica, and
    J. E. Gonzalez. \emph{MemGPT: Towards LLMs as Operating Systems.}
    arXiv:2310.08560, 2023. \url{https://arxiv.org/abs/2310.08560}. See also Letta
    (letta.com), the successor framework.
  \item[{[2]}] P. Chhikara, D. Khant, S. Aryan, T. Singh, and D. Yadav. \emph{Mem0:
    Building Production-Ready AI Agents with Scalable Long-Term Memory.}
    arXiv:2504.19413, 2025. \url{https://arxiv.org/abs/2504.19413}. Implementation:
